...
console.log j78.registeredObjects().length is 1 and j78.registeredObjects()[0] is s8
s7.disconnect()
console.log s7.joints().length is 0
s8.disconnect()
console.log s8.joints().length is 0
console.log j78.registeredObjects().length is 1 and j78.registeredObjects()[0] is s8
j78.register s7
console.log j78.registeredObjects().length is 2 and j78.registeredObjects().indexOf(s7) isnt -1 and j78.registeredObjects().indexOf(s8) isnt -1
...
console.log not j1112.isSmooth()
...
console.log j1516.getVertices().length is 2
j1516.straighten()
console.log j1516.getVertices().length is 0
