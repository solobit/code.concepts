...
concreteAggregate = uml.Class.create(
  rect:
    x: 95
    y: 250
    width: 130
...
concreteIterator = uml.Class.create(
  rect:
    x: 395
    y: 250
    width: 130
...
all = [client, aggregate, iterator, concreteAggregate, concreteIterator]
